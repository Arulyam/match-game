function createNewCard() {
  ...
  newCardDiv.innerHTML = `<div class="card-down"></div>
...
function appendNewCard(parentElement) {
  console.log("appendNewCard called");
  ...
  parentElement.appendChild(newCardElement);
...
function shuffleCardImageClasses() {
  console.log("shuffleCardImageClasses called");
...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for (let i = 0; i < shuffledImageClasses.length; ++i) {
    ...
    cardObjects.push({ index: i, element: newCardElement, imageClass: shuffledImageClasses[i] });
  }
...
function doCardsMatch(cardObject1, cardObject2) {
  console.log("doCardsMatch called");
...
async function onCardFlipped(newlyFlippedCard) {
  console.log("onCardFlipped called");
